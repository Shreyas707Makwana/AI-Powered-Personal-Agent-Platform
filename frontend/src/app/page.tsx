          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/60 backdrop-blur-sm border border-gray-700/50 p-10 rounded-2xl hover:scale-105 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 animate-slide-up group" style={{animationDelay: '0.1s'}}>
                ...
                <h3 className="text-2xl font-bold font-heading text-white mb-6">RAG-Powered Intelligence & Adaptive Agents</h3>
                <p className="text-gray-300 leading-relaxed text-lg mb-4">Advanced semantic retrieval provides precise, citation-backed answers from your documents. Create custom agents (instruction-based personalities) that augment RAG responses and act as specialized assistants for different workflows.</p>
              ...
              <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/60 backdrop-blur-sm border border-gray-700/50 p-10 rounded-2xl hover:scale-105 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 animate-slide-up group" style={{animationDelay: '0.2s'}}>
                ...
                <h3 className="text-2xl font-bold font-heading text-white mb-6">Long-Term Chat Memory</h3>
                <p className="text-gray-300 leading-relaxed text-lg mb-4">Save and recall conversation history across sessions. The assistant retains important facts and preferences so responses stay consistent and personalized even after sign out.</p>
              ...
              <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/60 backdrop-blur-sm border border-gray-700/50 p-10 rounded-2xl hover:scale-105 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 animate-slide-up group" style={{animationDelay: '0.3s'}}>
                ...
                <h3 className="text-2xl font-bold font-heading text-white mb-6">Secure, Extendable Tooling</h3>
                <p className="text-gray-300 leading-relaxed text-lg mb-4">Enterprise-grade security with Supabase Auth + RLS, and extensible tools (News, Weather). Only registered users can upload or query documents — ideal for private demo-ready SaaS experiences.</p>
