        ...
        <div className="min-h-[70vh] flex items-center justify-center px-6">
          <div className="quantum-card max-w-md w-full p-8 rounded-xl text-center">
            ...
            <div className="flex gap-3 justify-center">
              <button onClick={() => reset()} className="quantum-button px-4 py-2 rounded-md text-sm">Try Again</button>
              <a href="/" className="quantum-button px-4 py-2 rounded-md text-sm">Go Home</a>
            </div>
          </div>
        </div>
      </body>
